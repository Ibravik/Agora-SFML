...
int AgoraRTC::StartUp(const std::string _appID)
{
  ...
  if (!m_MediaEngine.queryInterface(m_RtcEngine, AGORA_IID_MEDIA_ENGINE))
  {
    return -1;
  }
  ...
  if (!m_VideoDeviceManager.queryInterface(m_RtcEngine, AGORA_IID_VIDEO_DEVICE_MANAGER))
  {
    return -1;
  }

  // create the audio device engine
  if (!m_AudioDeviceManager.queryInterface(m_RtcEngine, AGORA_IID_AUDIO_DEVICE_MANAGER))
  {
    return -1;
  }
  return 0;
...
std::vector<std::string> AgoraRTC::GetDeviceList(const eDEVICE_TYPE _deviceType)
{
  ...
  else if (_deviceType == eDEVICE_TYPE::kScreen)
  {
    ...
    while (lenght >= 0)
    {
      ...
      if (EnumDisplayDevices(NULL, lenght++, &device, 0))
      {
...
std::string AgoraRTC::GetDeviceID(const std::string _deviceName, const eDEVICE_TYPE _deviceType)
{
  ...
  else if (_deviceType == eDEVICE_TYPE::kScreen)
  {
    ...
    {
      if (_deviceName.find(std::string(screens.at(i))) != std::string::npos ||
          screens.at(i).find(_deviceName) != std::string::npos)
      {
        return _deviceName;
      }
    }
  ...
  for (int i = 0; i < lenght; ++i)
  {
    ...
    if (result >= 0 && 
        (_deviceName.find(std::string(name)) != std::string::npos || 
         std::string(name).find(_deviceName) != std::string::npos))
    {
...
std::string AgoraRTC::GetDeviceName(const std::string _deviceID, const eDEVICE_TYPE _deviceType)
{
  ...
  else if (_deviceType == eDEVICE_TYPE::kScreen)
  {
    ...
    for (size_t i = 0; i < screens.size(); i++)
    {
      if (_deviceID.find(std::string(screens.at(i))) != std::string::npos ||
          screens.at(i).find(_deviceID) != std::string::npos)
      {
        return _deviceID;
      }
    }
  ...
  for (int i = 0; i < lenght; ++i)
  {
    ...
    if (result >= 0 &&
        (_deviceID.find(std::string(id)) != std::string::npos ||
         std::string(id).find(_deviceID) != std::string::npos))
    {
...
int AgoraRTC::SetAudioRecordingVolume(const float _volume)
{
#if (ENABLE_AGORA_RTC == 0)
  return 0;
#endif
...
int AgoraRTC::SetAudioPlaybackVolume(const float _volume)
{
#if (ENABLE_AGORA_RTC == 0)
  return 0;
#endif
...
int AgoraRTC::MuteLocalAudioStream(const bool _switchFlag)
{
#if (ENABLE_AGORA_RTC == 0)
  return 0;
#endif
...
int AgoraRTC::MuteLocalVideoStream(const bool _switchFlag)
{
#if (ENABLE_AGORA_RTC == 0)
  return 0;
#endif
...
int AgoraRTC::MuteRemoteAudioStream(const unsigned int _userID, const bool _switchFlag)
{
#if (ENABLE_AGORA_RTC == 0)
  return 0;
#endif
...
int AgoraRTC::MuteRemoteVideoStream(const unsigned int _userID, const bool _switchFlag)
{
#if (ENABLE_AGORA_RTC == 0)
  return 0;
#endif
...
int AgoraRTC::SetVideoEncoderConfiguration(const VideoEncoderConfig& _config)
{
#if (ENABLE_AGORA_RTC == 0)
  return 0;
#endif
...
int AgoraRTC::SetRemoteVideoQuality(const unsigned int _userID, const eREMOTE_VIDEO_QUALITY _qualityType)
{
#if (ENABLE_AGORA_RTC == 0)
  return 0;
#endif
...
int AgoraRTC::SetRemoteVideoPriority(const unsigned int _userID, const eREMOTE_VIDEO_PRIORITY _priorityType)
{
#if (ENABLE_AGORA_RTC == 0)
  return 0;
#endif
...
int AgoraRTC::SetAudioEffect(const eAUDIO_EFFECT _effect)
{
#if (ENABLE_AGORA_RTC == 0)
  return 0;
#endif
  ...
  {
    result = m_RtcEngine->setAudioProfile(AUDIO_PROFILE_TYPE::AUDIO_PROFILE_DEFAULT, AUDIO_SCENARIO_TYPE::AUDIO_SCENARIO_DEFAULT);
    if (result < 0)
    {
      return result;
    }
...
int AgoraRTC::EnableVideoRecordingTest(const bool _switchFlag)
{
#if (ENABLE_AGORA_RTC == 0)
  return 0;
#endif
...
int AgoraRTC::EnableAudioRecordingTest(const bool _switchFlag)
{
#if (ENABLE_AGORA_RTC == 0)
  return 0;
#endif
...
int AgoraRTC::JoinChannel(const ChannelParams& _channelParams)
{
#if (ENABLE_AGORA_RTC == 0)
  return 0;
#endif
  ...
  result = m_RtcEngine->setRemoteDefaultVideoStreamType(REMOTE_VIDEO_STREAM_TYPE::REMOTE_VIDEO_STREAM_LOW);
  if (result < 0)
  {
    return result;
  }
...
int AgoraRTC::PublishStreamUrl(const std::string _url, const StreamConfig& _config)
{
#if (ENABLE_AGORA_RTC == 0)
  return 0;
#endif
  ...
  // Push stream
  return m_RtcEngine->addInjectStreamUrl(_url.c_str(), _config);
}

int AgoraRTC::RemoveStreamUrl(const std::string _url)
{
#if (ENABLE_AGORA_RTC == 0)
  return 0;
#endif
